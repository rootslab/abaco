...
exports.Abaco = ( function () {
    var log = console.log
        ...
        , parseFloat = function ( buff, base, start, end ) {
            ...
            if ( cut >= e - 1 ) {
                // ignore '.' char and fractional part
                return sign * ipart;
            }

            // parse fractional part
            // TODO: remove parseInt and while cycles.
            if ( cut === s ) {
                // initial '.'
                fpart = parseInt( b, bs, s + 1 );
            } else {
                // '.' char found in the middle
                fpart = parseInt( b, bs, cut + 1 );
            }
        ...
        , xparseFloat =function ( buff, base, start, end ) {
            ...
            if ( cut === s ) {
                // initial '.'
                fpart = xparseInt( b, bs, s + 1 );
            } else {
                // '.' char found in the middle
                fpart = xparseInt( b, bs, cut + 1 );
            }
