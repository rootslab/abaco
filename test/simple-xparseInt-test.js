...
var log = console.log
    ...
    , b5 = new Buffer( n5 )
    , r1 = parseInt( b1, 8 )
    , r2 = Abaco.xparseInt( b1, 8 )
    , r3 = parseInt( b1, 10 )
    , r4 = Abaco.xparseInt( b1, 10 )
    , r5 = parseInt( b2, 10 )
    , r6 = Abaco.xparseInt( b2, 10 )
    , r7 = parseInt( b3, 2 )
    , r8 = Abaco.xparseInt( b3, 2 )
    , r9 = parseInt( b4, 16 )
    , r10 = Abaco.xparseInt( b4, 16 )
    , r11 = parseInt( b5, 10 )
    , r12 = Abaco.xparseInt( b5, 10 )
    , r13 = parseInt( b1, 4 )
    , r14 = Abaco.xparseInt( b1, 4 )
    ;

log( '- test message: String -> parseInt( Number ), Abaco#xparseInt( Number ).' );
...
log( '- parse number with wrong radix returns NaN: %s -> %s, %s', n1, r13, r14 );
assert.ok( isNaN( r14 ) );